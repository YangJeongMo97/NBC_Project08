...
void ASpartaGameState::OnGameClear()
{
	if (APlayerController* PlayerController = GetWorld()->GetFirstPlayerController())
	{
		if (ASpartaPlayerController* SpartaPlayerController = Cast<ASpartaPlayerController>(PlayerController))
...
void ASpartaGameState::StartWave()
{
	...
	for (int32 i = 0; i < ItemToSpawn; i++)
	{
		...
		{
			ASpawnVolume* SpawnVolume = Cast<ASpawnVolume>(FoundVolumes[(int)FMath::FRandRange(0.f, FoundVolumes.Num())]);
			if (SpawnVolume)
			{
...
void ASpartaGameState::ClearItem()
{
	TArray<AActor*> SpawnedItems;

	UGameplayStatics::GetAllActorsOfClass(GetWorld(), AItemBase::StaticClass(), SpawnedItems);
